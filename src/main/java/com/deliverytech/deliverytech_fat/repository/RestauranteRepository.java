...
public interface RestauranteRepository extends JpaRepository<Restaurante, Long> {
     // Herdando de JpaRepository, o Spring nos dá de graça todos os comandos SQL básicos:
    // .save()    -> Faz o INSERT ou UPDATE no banco
    // .findAll() -> Faz o SELECT * FROM
    // .findById()-> Busca um registro específico pela chave primária (ID)
    // .delete()  -> Faz o DELETE no banco.
    // Buscar por nome
